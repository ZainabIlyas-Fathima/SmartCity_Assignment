/**
 * Location Class - Managed by Member 1
 * This class acts as the 'Node' for our Smart City Graph.
 * It's a simple wrapper for city names, but with extra logic to make
 * data handling much smoother and error-proof.
 */
public class Location {
    ...
    public Location(String name) {
         ...
         * It removes any accidental leading or trailing spaces if the user 
         * types " Colombo " instead of "Colombo".
         */
        this.name = name.trim();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Location) {
            // Casting the object and comparing names regardless of capital letters
